...
def ComputeIntervalActionsMSE(signal, intervals, original_signal):
   ...
   for i in range(len(intervals)):
      ...
      for action in actions:
         ...
         current_mse = mean_squared_error(original_signal[ll:rr], signal[ll:rr])
         new_mse = mean_squared_error(original_signal[ll:rr], new_signal)
...
def ComputeIntraIntervalMSE(signal, intervals, original_signal):
   ...
   for intra_interval in intra_intervals:
      ...
      mse = mean_squared_error(original_signal[l:r], signal[l:r])
